...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneController : MonoBehaviour
    {
        ...
        [SerializeField] private float m_Lift = 0.02f;               // The amount of lift generated by the aeroplane moving forwards.
        [SerializeField] private float m_ZeroLiftSpeed = 300;         // The speed at which lift is no longer applied.
        [SerializeField] private float m_RollEffect = 0.01f;             // The strength of effect for roll input.
        [SerializeField] private float m_PitchEffect = 0.01f;            // The strength of effect for pitch input.
        ...
        [SerializeField] private float m_AutoPitchLevel = 1f;       // How much the aeroplane tries to level when not pitching.
        [SerializeField] private float m_AirBrakesEffect = 3f;        // How much the air brakes effect the drag.
        [SerializeField] private float m_ThrottleChangeSpeed = 0.1f;  // The speed with which the throttle changes.
